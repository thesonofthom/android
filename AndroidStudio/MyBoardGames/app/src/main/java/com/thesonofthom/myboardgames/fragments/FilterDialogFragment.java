...
/**
 * Fragment to display a list of filters that the user can specify to show a subset of the visible game list
...
public class FilterDialogFragment extends DialogFragment
{
	...
	/**
	 * Dialog that allows the user to enter a specified number of players to filter by.
	 * Only games that can support the specified number of players will be shown
	 * @author Kevin Thomson
	 *
	 */
	...
	/**
	 * Dialog that allows the user to enter a specified playing time range to filter by.
	 * Only games that have an average playing time within the specified range will be shown
	 * @author Kevin Thomson
	 *
	 */
	...
	/**
	 * Dialog that allows the user to enter a specified year published range to filter by.
	 * Only games that were published within the specified range will be shown
	 * 
	 * @author Kevin Thomson
	 *
	 */	
	...
	/**
	 * Dialog that allows the user select from a list of categories to filter by.
	 * Only games that match at least one of the specified filters will be shown
	 * 
	 * @author Kevin Thomson
	 *
	 */	
	...
	/**
	 * Base class for all Filter alert dialogs
	 * @author Kevin Thomson
	 *
	 */
