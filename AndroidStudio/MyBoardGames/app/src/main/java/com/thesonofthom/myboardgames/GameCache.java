...
/**
 * Stores a list of games that can be sorted based on a set of criteria.
 * A single game can also be queried from the list in constant time
 * @author Kevin Thomson
 *
 */
public class GameCache
{
	private static final String TAG = "GameCache";
