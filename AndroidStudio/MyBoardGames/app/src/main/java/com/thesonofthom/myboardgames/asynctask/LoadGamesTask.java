...
/**
 * Task to load the list of games from local storage
 * @author Kevin
 *
 */
public class LoadGamesTask extends AsyncTaskFixed<Void, Integer, Boolean>
{
	...
	/**
	 * Generic constructor to be used by a any activity
	 * @param activity
	 * @param existingParser
	 */
	...
	/**
	 * Constructor to use when being called by the SplashScreenActivity
	 * @param splash
	 */
