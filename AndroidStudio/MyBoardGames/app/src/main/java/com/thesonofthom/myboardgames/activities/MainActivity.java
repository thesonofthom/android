...
/**
 * The main activity that all of the different fragment screens are spawned from
...
public class MainActivity extends BaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		File permanentImageDirectory = getExternalFilesDir(FileTools.PERMANENT_IMAGE_DIRECTORY);
		File imageCacheDirectory = getExternalFilesDir(FileTools.IMAGE_CACHE_DIRECTORY);
		imageLoader = new ImageLoader(permanentImageDirectory, imageCacheDirectory);
